...
<x-app-layout>
    ...
    <div>
        <x-slot name="header">
            {{ __('WELCOME TO ') . strtoupper(env('COMPANY_GROUP')) }}
            {{-- {{ __('WELCOME TO ') . strtoupper(env('COMPANY_NAME')) . __(' GROUP OF COMPANIES') }} --}}
        ...
        <div class="max-w-7xl mx-auto pt-1 sm:px-6 lg:px-8">
            <div
                class="px-2 py-3 bg-white sm:p-6 shadow {{ isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md' }}">
                <div class="row px-3">
                        ...
                        <ol>
                            <li>
                                ...
                                <p class="h6 text-justify">
                                    One Document Corporation is focused on Information Technology-related project
                                    developments and technology-based solutions, on its decade of existence this 2021 is
                                    expanding its reach through program-based versatile integrated systems that
                                    accelerate progress for any business operations.
                                </p>

                                <p>Mission:</p>
                                <p class="h6 text-justify">
                                    To have the entrepreneurial spirit in the continuous search for project
                                    opportunities, vigilant in growing from current businesses focused on our customers,
                                    and from new initiatives through ingenuity and reinvention, always committed to
                                    deliver dependable goods and services, locally and globally.
                                </p>

                                <p>Vision:</p>
                                <p class="h6 text-justify">
                                    To be a recognized socially-responsible leader in productive and
                                    profitabletechnology-based project developments, committed to improve lives, here
                                    and/or abroad
                                </p>
                            </li>
                        </ol>
                            ...
                            <div class="carousel-inner">
                                @if (date('a') == 'am')
                                    <div class="carousel-item active" style="height: 450px !important;">
                                        <img src="{{ asset('img/carousel/goodmorning.jpg') }}"
                                            class="d-block w-100 h-100" alt="...">
                                    </div>
                                    <div class="carousel-item" style="height: 450px !important;">
                                        <img src="{{ asset('img/carousel/1.jpg') }}" class="d-block w-100 h-100"
                                            alt="...">
                                    </div>
                                @else
                                    <div class="carousel-item active" style="height: 450px !important;">
                                ...
                                @endif
                                <div class="carousel-item" style="height: 450px !important;">
                                    <img src="{{ asset('img/carousel/2.jpg') }}" class="d-block w-100 h-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item" style="height: 450px !important;">
                                    <img src="{{ asset('img/carousel/3.jpg') }}" class="d-block w-100 h-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item" style="height: 450px !important;">
                                    <img src="{{ asset('img/carousel/4.jpg') }}" class="d-block w-100 h-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item" style="height: 450px !important;">
                                    <img src="{{ asset('img/carousel/5.jpg') }}" class="d-block w-100 h-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item" style="height: 450px !important;">
                                    <img src="{{ asset('img/carousel/6.jpg') }}" class="d-block w-100 h-100"
                                        alt="...">
                                </div>
                            </div>
                ...
                <div class="row px-3 image-container justify-content-center align-items-center text-center">
    ...
    <x-jet-input type="text" id="date_compare"
        value="{{ substr(Auth::user()->birthdate, 5, 5) . '|' . substr(Carbon\Carbon::now(), 5, 5) }}" hidden />
