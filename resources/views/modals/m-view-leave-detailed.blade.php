            ...
            @if (Auth::user()->employee_id == $dLeave->supervisor && $dLeave->leave_status == 'Pending')
                    ...
                    <select name="dLtype" id="dLtype"
                        ...
                        @foreach ($leaveTypes as $leave_type)
                            <option value="{{ $leave_type->leave_type }}"
                                @if ($dLeave->leave_type == $leave_type->leave_type) selected @endif>{{ $leave_type->leave_type_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div id="divLOthers" name="divLOthers" @if ($dLeave->leave_type != 'Others') hidden @endif>
                    <x-jet-input id="dLOthers" name="dLOthers" class="w-full" type="text"
                        placeholder="Specify leave here..." value="{{ $dLeave->others }}" autocomplete="off" />
                </div>
            @else
            ...
            <div class="row text-left">
                <div class="col-md-12 sm:col-span-5 sm:justify-center text-sm">
                    ...
                    <ol>
                        ...
                        <li>
                            2. Application for sick leave of more than two (2) consecutive days must be supported by a
                            medical certificate.
                        </li>
                    </ol>
                </div>
