    ...
    <div>
        <div class="max-w-6xl mx-auto mt-2">
            ...
            <form id="leave-form" method="POST" action="{{ route('hris.leave.eleave') }}">
                ...
                <div class="px-5 pt-3 sm:p-6 shadow bg-white {{ isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md' }}">
                        ...
                        <div class="col-md-2 p-1">
                            ...
                            <div class="form-floating">
                                ...
                                <div id="div_others" name="div_others" hidden>
                                    <x-jet-input id="others_leave" name="others_leave" type="text" class="mt-1 block w-full" placeholder="Specify leave here..." />
