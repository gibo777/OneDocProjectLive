                        ...
                        <div class="row col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6 p-0">
                                        <div class="form-floating text-center">
                                            <x-jet-input id="otDateFrom" name="otDateFrom" type="date"
                                                class="form-control w-full" placeholder="mm/dd/yyyy" autocomplete="off"
                                                required />
                                    ...
                                    <div class="col-md-6 p-0">
                                        <div class="form-floating text-center">
                                            <x-jet-input id="otTimeFrom" name="otTimeFrom" type="time"
                                                class="form-control w-full" placeholder="mm/dd/yyyy" autocomplete="off"
                                                required />
                                            <label for="otDateFrom" class="font-weight-bold text-secondary">
                            ...
                            <div class="col-md-6 mt-2 align-center px-3 inset-shadow">
                                <div class="row">
                                    <div class="col-md-6 p-0">
                                        <div class="form-floating text-center">
                                            <x-jet-input id="otDateTo" name="otDateTo" type="date"
                                                class="form-control w-full" placeholder="mm/dd/yyyy" autocomplete="off"
                                                required />
                                    ...
                                    <div class="col-md-6 p-0">
                                        <div class="form-floating text-center">
                                            <x-jet-input id="otTimeTo" name="otTimeTo" type="time"
                                                class="form-control w-full" placeholder="mm/dd/yyyy" autocomplete="off"
                                                required />
                                            <label for="otDateTo" class="font-weight-bold text-secondary">
