<x-app-layout>
            ...
            <div class="col-span-8 sm:col-span-8">
                <form id="memo-form" action="{{ route('tmp.file.preview') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 py-2 hidden" id="mobile-view">
                            <ul class="nav nav-tabs">
                                <li class="nav-link active"><a data-toggle="tab" href="#general-memo-mobile">General
                                        Memo</a></li>
                                <li class="nav-link"><a data-toggle="tab" href="#specific-memo-mobile">Specific Memo</a>
                                </li>
                                <li class="">
                                    <x-jet-button name="add_memo" class="btn btn-primary btn-sm" aria-pressed="true">Add
                                        Memo</x-jet-button>
                                </li>
                            </ul>
                        ...
                        <!-- MEMO PREVIEW -->
                        <div
                            class="row justify-content-center col-md-8 bg-gray-200 border items-center justify-center border border-secondary rounded-left">
                            <!-- <iframe id="preview-memo" src="http://localhost:8000/view-pdf" class="col-md-12" width="100%" height="550"> -->
                            <iframe id="preview-memo" src="https://www.africau.edu/images/default/sample.pdf"
                                class="h-100 w-full" width="100%">
                        ...
                        <div class="col-md-4 py-0 bg-light border border-secondary h-100" id="desktop-view">
                            ...
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button id="pills-general-tab" class="nav-link active" data-bs-toggle="pill"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button id="pills-ad-tab" class="nav-link" data-bs-toggle="pill"
                                        data-bs-target="#pills-ad" type="button" role="tab"
                                        aria-controls="pills-ad" aria-selected="false">
                                        Personal
                                    </button>
                                </li>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="list-group" id="general-list-tab" role="tablist">
                                                    @foreach ($memos as $key => $memo)
                                                        @if ($memo->memo_send_option == 'g')
                                                            <a class="list-group-item list-group-item-action cut-text {{ $memo->is_viewed == 1 ? 'bg-viewed' : '' }}"
                                                                data-value="{{ $memo->file_name }}"
                                                                name="g-memo-list[]" id="{{ $memo->id }}"
                                ...
                                {{-- PERSONAL MEMO --}}
                                <div class="tab-pane fade" id="pills-ad" role="tabpanel"
                                    aria-labelledby="pills-ad-tab">
                                    <div class="w-full pr-3 ">
                                        <div class="row">
                                            <div class="col-12">
                    ...
                    @endforeach*/
                                ...
                                <div class="tab-pane fade" id="pills-fb" role="tabpanel"
                                    aria-labelledby="pills-fb-tab">
                                    test 3
                                </div>
                            </div>
                        ...
                        <div class="w-full pr-3 ">
                            ...
                            <div id="add-memo-desktop" class="tab-pane fade">
                                <div class="col-span-6 px-2 py-1 sm:col-span-6 w-full">
                                    ...
                                    <x-jet-input id="memo_subject" name="memo_subject" type="text"
                                ...
                                <div id="div_memo_recepients" class="col-span-6 sm:col-span-2 px-2 w-full hidden">
                                    ...
                                    <x-jet-label for="memo_recipient" value="{{ __('Memo Recipient:') }}"
                                        class="pt-3" />
                                    <select id="memo_recipient" name="memo_recipient[]"
                                        class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full"
                                        placeholder="Search" style="width: 100%;" multiple="multiple">
                                ...
                                <div class="px-2 pt-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <x-jet-input type="file" class="custom-file-input"
                                                id="inputGroupFile02" name="inputGroupFile02[]" disabled multiple />

                                            <x-jet-label class="custom-file-label" for="inputGroupFile02"
                                ...
                                <div class="p-1">
                                    <div class="input-group mb-3 items-center justify-center">
                                        <div class="input-group-append">
                                            <x-jet-button class="btn btn-secondary btn-sm" id="preview_memo"
                                                value="{{ __('Preview') }}"
                                                disabled>{{ __('Preview') }}</x-jet-button>
                                        </div>
                                        <div class="input-group-append">
                                            <x-jet-button class="btn btn-primary btn-sm" id="send_memo"
                                                value="{{ __('Preview') }}"
                                                disabled>{{ __('Send Memo') }}</x-jet-button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- =========================================== -->
    <!-- Modal for History -->
    <div class="modal fade" id="modalMemoCreation" tabindex="-1" role="dialog"
        aria-labelledby="memoCreationLabel" data-backdrop="static">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button id="closeModal" type="button" class="close btn btn-primary fa fa-close"
            ...
            $("[name='g-memo-list[]']").each(function() {
                $(this).on('click', function() {
                    ...
                    $.ajax({
                        ...
                        method: 'get',
                        data: {
                            'file_path': "{{ str_replace('\\', '/', public_path('storage/memo-files/')) }}" +
                                $(this).data('value')
            ...
            function append_memo(data, option) {
                ...
                for (var n = 0; n < data.length; n++) {
                    ...
                    if (data[n]['memo_send_option'] == option) {
                        ...
                        if (data[n]['is_viewed'] == 1) {
                            bg_viewed = 'bg-viewed';
                        } else {
                            bg_viewed = '';
                        }
                        $(list_tab).append('<a class="list-group-item list-group-item-action cut-text ' +
                            bg_viewed + '" data-value="' + data[n]['file_name'] + '" name="' + option +
                            '-memo-list[]" id="' + data[n]['id'] +
                            '" data-toggle="list" href="#list-home" role="tab" aria-controls="home">' + data[n][
                                'uploaded_at'
                            ] + ' - ' + data[n]['memo_subject'] + '</a>');
                        $(list_tab).append('<input type="hidden" name="' + data[n]['id'] + '" value="' + data[n][
                            'is_viewed'
                        ] + '">');
                    }
                }
    ...
    <!-- loading-blue-circle -->
    <div class="modal in bg-light opacity-75" id="loadingModal" tabindex="-1" role="dialog"
