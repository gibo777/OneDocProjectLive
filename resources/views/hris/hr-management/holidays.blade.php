                                    ...
                                    <table id="data_holidays" class="table table-bordered table-striped sm:justify-center table-hover tabledata">
                                        ...
                                        <tbody class="data hover" id="viewHolidays">
                                            @foreach($holidays as $holiday)
                                                <tr id="{{ join('|',[$holiday->id,$holiday->date,$holiday->holiday,$holiday->holiday_type]) }}">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="form-floating px-1">
                        <select name="holiday_offices" id="holiday_category" class="form-control border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block">
