                ...
                <div class="col-md-4 py-0 bg-light border border-secondary h-100" id="desktop-view">
                  <ul class="nav nav-tabs">
                      ...
                      <li class="nav-link">
                          ...
                          @foreach ($memo_counts as $key=>$memo_count)
                            @if ($memo_count->memo_send_option=='s')
                              ...
                              <div class="col-12">
                                <div class="list-group" id="general-list-tab" role="tablist">
                                  ...
                                  @if ($memo->memo_send_option=='g')
                                    <a class="list-group-item list-group-item-action cut-text {{ ($memo->is_viewed==1) ? 'bg-viewed' : '' }}" data-value="{{ $memo->file_name }}" name="g-memo-list[]" data-toggle="list" href="#list-home" role="tab" aria-controls="home">
                        ...
                        <div class="px-2 pt-3">
                            <div class="input-group mb-3">
                              ...
                              <div class="custom-file">
                                <x-jet-input type="file" class="custom-file-input" id="inputGroupFile02" 
                                disabled/>
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              for (var n=0; n<data.length; n++) {
                ...
                if (data[n]['memo_send_option']=='s') {
                  // prompt('', data[n]['memo_subject']);
                  $("#personal-list-tab").append('<a class="list-group-item list-group-item-action cut-text" data-value="'+data[n]['file_name']+'" name="p-memo-list[]" data-toggle="list" href="#list-home" role="tab" aria-controls="home">'+data[n]['uploaded_at']+' - '+data[n]['memo_subject']+'</a>');
                }
              }
