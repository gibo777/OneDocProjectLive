...
<body class="font-sans antialiased">
    ...
    <div class="d-flex">
        <div id="sideBar" class="bg-dark text-white p-2" style="width: 250px; min-height: 100vh;">
            ...
            <ul class="nav flex-column font-weight-bold" id="sidebarMenu">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link text-white" onclick="toggleMenu(event, 'eformMenu')">E-Form</a>
                    <ul class="nav flex-column ms-3 submenu" id="eformMenu">
                        <li class="nav-item"><a href="#" class="nav-link text-white">E-Leave</a></li>
                        <li class="nav-item"><a href="#" class="nav-link text-white">Overtime</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="nav flex-column ms-3 submenu" id="recMgtMenu">
                        <li class="nav-item"><a href="#" class="nav-link text-white">Employee Management</a></li>
                        <li class="nav-item"><a href="#" class="nav-link text-white">Timekeeping</a></li>
                    </ul>
                </li>
                <li class="nav-item">
