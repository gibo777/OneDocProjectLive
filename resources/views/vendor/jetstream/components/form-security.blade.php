...
<div {{ $attributes->merge(['class' => 'md:grid md:grid-cols-6 md:gap-2']) }}>
    <x-jet-section-title>
    ...
    <div class="mt-1 md:mt-0 md:col-span-3">
        <form wire:submit.prevent="{{ $submit }}">
            <div class="px-4 py-3 flex items-center justify-center bg-white sm:p-6 shadow {{ isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md' }}">
