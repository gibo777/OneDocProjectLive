    ...
    <form id="accountingDataForm">
        ...
        <div class="col-span-12 sm:col-span-12 mx-4">
            @if (Auth::user()->role_type == 'SUPER ADMIN')
                <div class="row pt-2">
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="vacation_leaves" type="text"
                            class="leaves form-control text-center block w-full" autocomplete="off"
                            value="{{ $leaves->VL != null ? $leaves->VL : 0 }}" readonly />
                        <x-jet-label for="vacation_leaves" value="{{ __('Vacation Leaves') }}"
                            class="text-black-50 w-full" />
                        <x-jet-input-error for="vacation_leaves" class="mt-2" />
                    </div>
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="sick_leaves" type="text"
                            class="leaves form-control text-center block w-full" autocomplete="off"
                            value="{{ $leaves->SL != null ? $leaves->SL : 0 }}" readonly />
                        <x-jet-label for="sick_leaves" value="{{ __('Sick Leaves') }}" class="text-black-50 w-full" />
                        <x-jet-input-error for="sick_leaves" class="mt-2" />
                    </div>
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="maternity_leaves" type="text"
                            class="leaves form-control text-center block w-full" autocomplete="off"
                            value="{{ $leaves->ML != null ? $leaves->ML : 0 }}" readonly />
                        <x-jet-label for="maternity_leaves" value="{{ __('Maternity Leaves') }}"
                            class="text-black-50 w-full" />
                        <x-jet-input-error for="civil_status" class="mt-2" />
                    </div>
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="paternity_leaves" type="text"
                            class="leaves form-control text-center block w-full" autocomplete="off"
                            value="{{ $leaves->PL != null ? $leaves->PL : 0 }}" readonly />
                        <x-jet-label for="paternity_leaves" value="{{ __('Paternity Leaves') }}"
                            class="text-black-50 w-full" />
                        <x-jet-input-error for="paternity_leaves" class="mt-2" />
                    </div>
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="emergency_leaves" type="text"
                            class="leaves form-control text-center block w-full" autocomplete="off"
                            value="{{ $leaves->EL != null ? $leaves->EL : 0 }}" readonly />
                        <x-jet-label for="emergency_leaves" value="{{ __('Emergency Leaves') }}"
                            class="text-black-50 w-full" />
                        <x-jet-input-error for="emergency_leaves" class="mt-2" />
                    </div>
                    <div class="col-md-2 form-floating px-1">
                        <x-jet-input id="others" type="text" class="leaves form-control text-center block w-full"
                            autocomplete="off" value="{{ $leaves->others != null ? $leaves->others : 0 }}" readonly />
            ...
            <div class="row py-2">
                <div class="col-md-3 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="sss_number" name="sss_number" type="text"
                            class="accounting form-control block w-full" placeholder="SSS Number" autocomplete="off"
                ...
                <div class="col-md-3 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="phic_number" name="phic_number" type="text"
                            class="accounting form-control block w-full" placeholder="PHIC Number" autocomplete="off"
                ...
                <div class="col-md-3 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="pagibig_number" name="pagibig_number" type="text"
                            class="accounting form-control block w-full" placeholder="PAG-IBIG Number"
                            autocomplete="off" value="{{ $accData->pagibig_number }}" />
                ...
                <div class="col-md-3 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="tin_number" name="tin_number" type="text"
                            class="accounting form-control block w-full" placeholder="TIN Number" autocomplete="off"
                            value="{{ $accData->tin_number }}" />
                ...
                <div class="col-md-9 dependents" id="dependents">
                        ...
                        @foreach ($dependents as $dependent)
                            <div class="row dependentsRow">
                                <div class="col-md-8 p-1">
                                    <div class="form-floating col-span-8 sm:col-span-1">
                                        <x-jet-input record_id="{{ $dependent->id }}" name="dependent_name"
                                            id="dependent_name{{ $loop->iteration }}" type="text"
                                            class="dependentsName form-control block w-full" autocomplete="off"
                                            placeholder="Dependent" value="{{ $dependent->dependent_name }}" />
                                        <x-jet-label for="dependent_name{{ $loop->iteration }}"
                                            value="{{ __('Dependent ') }} {{ $loop->iteration }}" />
                                        <x-jet-input-error for="dependent_name{{ $loop->iteration }}"
                                            class="mt-2" />
                                    </div>
                                </div>
                                <div class="col-md-3 p-1">
                                    <div class="form-floating col-span-8 sm:col-span-1">
                                        <x-jet-input record_id="{{ $dependent->id }}" name="dependent_birthdate"
                                            id="dependent_birthdate{{ $loop->iteration }}" type="text"
                                            class="dependentsBday form-control datepicker block w-full"
                                            placeholder="mm/dd/yyyy" value="{{ $dependent->dependent_birthdate }}" />
                                        <x-jet-label for="dependent_birthdate{{ $loop->iteration }}"
                                            value="{{ __('Birthdate') }}" />
                                        <x-jet-input-error for="dependent_birthdate{{ $loop->iteration }}"
                                            class="mt-2" />
                                    </div>
                                </div>
                                @if ($loop->iteration == 1)
                                    <div class="d-flex justify-content-center col-md-1 p-3">
                                        <i name="btnDependents[]"
                                            class="btnDependents d-flex justify-content-center fa fa-solid fa-plus btn btn-success btn-success-3d"
                                            data-bs-toggle="tooltip" title="Add dependent"></i>
                                    </div>
                                @endif
                            </div>
                        @endforeach
                    @else
                        <div class="row dependentsRow">
                            <div class="col-md-8 p-1">
                                <div class="form-floating col-span-8 sm:col-span-1">
                                    <x-jet-input name="dependent_name" id="dependent_name1" type="text"
                                        class="dependentsName form-control block w-full" autocomplete="off"
                            ...
                            <div class="col-md-3 p-1">
                                <div class="form-floating col-span-8 sm:col-span-1">
                                    <x-jet-input name="dependent_birthdate" id="dependent_birthdate1" type="text"
                                        class="dependentsBday form-control datepicker block w-full"
            ...
            <div class="row pb-2">
                <div class="col-md-3 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="health_card_number" type="text"
                            class="accounting form-control block w-full" placeholder="Health Card Number"
                            autocomplete="off" value="{{ $accData->health_card_number }}" />
                ...
                <div class="col-md-2.5 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="drivers_license" type="text" class="accounting form-control block w-full"
                            placeholder="Driver's License" autocomplete="off"
                            value="{{ $accData->drivers_license }}" />
                ...
                <div class="col-md-2.5 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="passport_number" type="text" class="accounting form-control block w-full"
                            placeholder="Passport Number" autocomplete="off"
                            value="{{ $accData->passport_number }}" />
                ...
                <div class="col-md-2 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="passport_expiry" type="text"
                            class="accounting form-control datepicker block w-full" placeholder="mm/dd/yyyy"
                            value="{{ $accData->passport_expiry }}" />
                ...
                <div class="col-md-2 p-1">
                    <div class="form-floating col-span-8 sm:col-span-1">
                        <x-jet-input id="prc" type="text" class="accounting form-control block w-full"
                            placeholder="PRC" value="{{ $accData->prc }}" />
            ...
            <div
                class="flex items-center justify-center px-2 py-2 text-right sm:px-3  sm:rounded-bl-md sm:rounded-br-md">
