...
<?php $component->withAttributes([]); ?>
         ...
         <?php $__env->endSlot(); ?>
            <div class="drop-shadow">
                <img src="<?php echo e(asset('/img/company/onedoc-logo.png')); ?>" class="rounded mx-auto d-block pb-3"/>
                <!-- <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'email','class' => 'block mt-1 w-full','type' => 'email','name' => 'email','value' => old('email'),'required' => true,'autofocus' => true,'autocomplete' => 'off']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-center">
                <?php if(Route::has('password.request')): ?>
                    ...
                    <a class="underline text-md text-gray-600 hover:text-gray-900" href="<?php echo e(route('password.request')); ?>">
                        <?php echo e(__('Forgot your password?')); ?>

                    </a>
                   <!--  &nbsp;|&nbsp; 
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('register')); ?>">
                        <?php echo e(__('Not yet registered?')); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-center mt-3">
                <span class="text-sm">Copyright © <?php echo e(env('COMPANY_NAME')); ?></span>
            </div>
...
<?php /**PATH C:\xampp\htdocs\OneDocProjectLive_10232023\OneDocProjectLive\resources\views/auth/login.blade.php ENDPATH**/ ?>