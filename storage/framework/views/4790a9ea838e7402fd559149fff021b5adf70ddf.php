...
<body>
    ...
    <div>
        <div class="row">
            <div class="columnHeader">
                ...
                <img src='data:image/jpeg;base64, <?php echo e($data['imageLogo']); ?>' width="275px" height="70px" />
            </div>
            <div class="columnHeader">
                <div class="headerLabel" style="float: right; "> Control No. <?php echo e($data['leave_details'][0]->control_number); ?> <br>
                    </div>
            </div>
        </div>
    ...
    <?php $__currentLoopData = $data['leave_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row">
            <div class="column">
                <label class="Label">NAME : <?php echo e($leave_detail->name); ?></label><br>
                <label class="Label">DEPARTMENT : <?php echo e($leave_detail->department); ?> </label><br>
                <label class="containerleft"> Re-filling
                    <span class="checkmark"></span>
                </label>
            </div>
            <div class="column">
                <label class="Label">DATE FILE : <?php echo e(date('m/d/Y g:i A', strtotime($leave_detail->date_applied))); ?> </label><br>
                <label class="Label">EMPLOYEE : <?php echo e($leave_detail->employee_id); ?> </label><br>
        ...
        <div class="container1">
            <div class="Label"> LEAVE TYPE: <?php echo e($leave_detail->leave_type); ?> </div>
            <div class="Label"> REASON: <?php echo e($leave_detail->reason); ?> </div> <br>
        ...
        <div class="container1">
            <div class="Label">FROM:<u><?php echo e($leave_detail->date_from); ?></u> TO: <u><?php echo e($leave_detail->date_to); ?></u>

                <label style="float: right;">NUMBER OF DAYS: <u><?php echo e($leave_detail->no_of_days); ?></u></label>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\OneDocProjectLive\resources\views/reports/leave-form.blade.php ENDPATH**/ ?>