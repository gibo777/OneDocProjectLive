...
<div <?php echo e($attributes->merge(['class' => 'md:grid md:grid-cols-6 md:gap-2'])); ?>>
...
<?php endif; ?>
    ...
    <div class="mt-1 md:mt-0 md:col-span-3">
        <form wire:submit.prevent="<?php echo e($submit); ?>">
            <div class="px-4 py-3 flex items-center justify-center bg-white sm:p-6 shadow <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
...
<?php /**PATH C:\xampp\OneDocProject\htdocs\OneDocProjectLive\resources\views/vendor/jetstream/components/form-security.blade.php ENDPATH**/ ?>