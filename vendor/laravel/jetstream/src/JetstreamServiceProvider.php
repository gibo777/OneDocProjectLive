...
use Laravel\Jetstream\Http\Livewire\SubmitLeaveForm;
...
class JetstreamServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->afterResolving(BladeCompiler::class, function () {
            if (config('jetstream.stack') === 'livewire' && class_exists(Livewire::class)) {
                ...
                Livewire::component('livewire.accounting-data', UpdateAccountingDataForm::class);
                Livewire::component('profile.update-password-form', UpdatePasswordForm::class);
                Livewire::component('profile.two-factor-authentication-form', TwoFactorAuthenticationForm::class);
                Livewire::component('profile.logout-other-browser-sessions-form', LogoutOtherBrowserSessionsForm::class);
                Livewire::component('profile.delete-user-form', DeleteUserForm::class);

                Livewire::component('hris.leave.eleave', SubmitLeaveForm::class);
    ...
    protected function configureComponents()
    {
        $this->callAfterResolving(BladeCompiler::class, function () {
            ...
            $this->registerComponent('table-border');
            $this->registerComponent('table-field');
            $this->registerComponent('form-module');
            $this->registerComponent('form-security');
            $this->registerComponent('gilbert');
            $this->registerComponent('personnel-component');
            $this->registerComponent('dropdown-clickable');

            $this->registerComponent('field-required');
        });
    }
