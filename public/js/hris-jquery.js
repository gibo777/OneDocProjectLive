...
$('.tabledata').DataTable();
    ...
    $("#save_holiday").click(function () {
            ...
            if ($(this).html()=="SAVE") {
                ...
                $("#dialog_content").html("Holiday successfully added!");
            } else {
    ...
    function officeValidation (office_code='', office_address='', office_city='', office_province='', office_country='', office_zipcode='', office_tin='', office_contact='') {
        empty_fields=0;
    ...
    $("#office_province").on('change paste keyup keydown', function() {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for (var n=0; n<data.length; n++) {
                    $("#office_city").append("<option>"+data[n]['city']+"</option>");
                }
    ...
    $("#office_country").on('change paste keyup keydown', function() {
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("#office_province").append('<option value="">-Select Province-</option>');
                for (var n=0; n<data.length; n++) {
    ...
    $("#office_zipcode").on('change paste keyup keydown', function(e) {
